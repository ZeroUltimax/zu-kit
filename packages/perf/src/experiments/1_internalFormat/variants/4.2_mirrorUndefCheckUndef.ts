...
// Same props, differentiated by nullable fields
interface Success<S> {
  readonly succ: S;
...
export const mirrorUndefCheckUndef: Variant<ResultFormatVariant> = {
  id: "4.2",
  name: "mirrorUndefCheckUndef",
